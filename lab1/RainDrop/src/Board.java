		...
		for (x = 0; x < points.length; ++x) {
			for (y = 0; y < points[x].length; ++y) {
				if (points[x][y].getState() != 0) {
					...
					case 1:
						g.setColor(new Color(0xBCD2E8));
						break;
					case 2:
						g.setColor(new Color(0x91BAD6));
						break;
					case 3:
						g.setColor(new Color(0x73A5C6));
						break;						
					case 4:
						g.setColor(new Color(0x528AAE));
						break;						
					case 5:
						g.setColor(new Color(0x2E5984));
						break;						
					case 6:
						g.setColor(new Color(0x1E3F66));
						break;						
					}
